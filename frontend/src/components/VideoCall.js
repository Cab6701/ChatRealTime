...
function Controls() {
    ...
    return (
        <div>
            <ExitToAppIcon className="controlsIcon" onClick={() => leave()}>Leave</ExitToAppIcon>
            {enbMic ? <MicIcon className="controlsIcon" onClick={() => {
                toggleMic();
                setEnbMic(false);
            }} /> :
                <MicOffIcon className="controlsIcon" onClick={() => {
                    toggleMic();
                    setEnbMic(true);
                }} />
            }
            {enbCam ? <VideocamIcon className="controlsIcon" onClick={() => {
                toggleWebcam();
                setEnbCam(false);
            }} /> :
                <VideocamOffIcon className="controlsIcon" onClick={() => {
                    toggleWebcam();
                    setEnbCam(true);
                }} />
            }
    ...
    return (
        <div className="container">
            ...
            {joined && joined === "JOINED" ? (
                ...
                <p style={{ color: "white", marginTop: "10px" }}>Joining the meeting...</p>
            ) : (
